...
def default_source_registry() -> EvidenceSourceRegistry:
    ...
    public_sources = [
        ...
        SourceRecord(source_id="loinc", provider="Regenstrief Institute", name="LOINC FHIR Terminology Service", endpoint="https://fhir.loinc.org", authority_class="standards_terminology", license="LOINC license", access_policy="public", allowed_use="Terminology interoperability subject to LOINC terms", update_frequency="release-based", version_strategy="LOINC release", schema_version="FHIR R4", identifier_namespaces=["loinc"], entity_types=[EntityType.BIOMARKER, EntityType.PHENOTYPE]),
